...
//DI GANTI MENYESUAIKAN TABLE/ KALO INI TABLE REKAM MEDIS/DIGANTI MENYESUIKAN DATA TABLE
	if (isset($_POST['btn_simpan']))
	{
		...
		if(!empty($id_pasien) && !empty($keluhan) && !empty($id_dokter) && !empty($diagnosa)&& !empty($id_poliklinik)&& !empty($riwayat) && !empty($tgl_periksa))
		{
			$sql = "INSERT INTO tb_rekammedis (id_rm, id_pasien, keluhan, id_dokter, diagnosa, id_poliklinik, riwayat, obat1, obat2, obat3, obat4, obat5, obat6, tindakan, tgl_periksa ) 
			        VALUES(".$id_rm.",'".$id_pasien."','".$keluhan."', '".$id_dokter."','".$diagnosa."','".$id_poliklinik."','".$riwayat."','".$obat1."','".$obat2."','".$obat3."','".$obat4."', '".$obat5."', '".$obat6."', '".$tindakan."', '".$tgl_periksa."')";
	           ...
	           <div class="control-group">
            	...
            	<div class="control-group">
	              <div class="form-group floating-label-form-group controls mb-0 pb-2">
	                ...
	                <input class="form-control" id="riwayat" type="text" name="riwayat" placeholder="Riwayat Penyakit " required="required" data-validation-required-message="Silahkan Masukkan Riwayat Penyakit Pasien">
	                <p class="help-block text-danger"></p>
	              </div>
	            </div>
            	<!-- RIWAYAT PENYAKIT -->	
            	<!-- REKAM OBAT -->
   				<div class="control-group">
	            <div class="form-group floating-label-form-group controls mb-0 pb-2">
		        <input class="form-control" id="hai" name="hai" type="text" placeholder="DATA OBAT" disabled="disabled">

		        <!-- data obat baru -->
		        <!-- data obat 1 -->
		        <select name="obat1" class="form-control" placeholder="Obat 1" id="obat1" type="select"> 
	             	<?php $sqlobat1 = "SELECT * FROM tb_obat";
					$queryobat1 = mysqli_query($koneksi, $sqlobat1); ?>
	             	<?php while($dataobat1 = mysqli_fetch_assoc($queryobat1)){ ?>
					<option value="<?php echo $dataobat1['id_obat']; ?>">
					<?php echo $dataobat1['nama_obat']; ?>
					</option>
					<?php } ?>
...
<!--	            	<input class="form-control" id="obat1" type="text" name="obat1" placeholder="Jumlah Obat 1">-->
	            	<!-- data obat 1 -->


					<!-- data obat 2 -->
		        <select name="obat2" class="form-control" placeholder="Obat 2" id="obat2" type="select"> 
	             	<?php $sqlobat2 = "SELECT * FROM tb_obat";
					$queryobat2 = mysqli_query($koneksi, $sqlobat2); ?>
	             	<?php while($dataobat2 = mysqli_fetch_assoc($queryobat2)){ ?>
					<option value="<?php echo $dataobat2['id_obat']; ?>">
					<?php echo $dataobat2['nama_obat']; ?>
					</option>
					<?php } ?>
	            	...
	            	<!--<input class="form-control" id="obat2" type="text" name="obat2" placeholder="Jumlah Obat 2">
-->	            	<!-- data obat 2 -->
	            	<!-- data obat 3 -->
		        <select name="obat3" class="form-control" placeholder="Obat 3" id="obat3" type="select"> 
	             	<?php $sqlobat3 = "SELECT * FROM tb_obat";
					$queryobat3 = mysqli_query($koneksi, $sqlobat3); ?>
	             	<?php while($dataobat3 = mysqli_fetch_assoc($queryobat3)){ ?>
					<option value="<?php echo $dataobat3['id_obat']; ?>">
					<?php echo $dataobat3['nama_obat']; ?>
					</option>
					<?php } ?>
	            	...
	            	<!--<input class="form-control" id="obat3" type="text" name="obat3" placeholder="Jumlah Obat 3">-->
	            	<!-- data obat 3 -->
	            	<!-- data obat 4 -->
		        <select name="obat4" class="form-control" placeholder="Obat 4" id="obat4" type="select"> 
	             	<?php $sqlobat4 = "SELECT * FROM tb_obat";
					$queryobat4 = mysqli_query($koneksi, $sqlobat4); ?>
	             	<?php while($dataobat4 = mysqli_fetch_assoc($queryobat4)){ ?>
					<option value="<?php echo $dataobat4['id_obat']; ?>">
					<?php echo $dataobat4['nama_obat']; ?>
					</option>
					<?php } ?>
	            	...
	            	<!--<input class="form-control" id="obat4" type="text" name="obat4" placeholder="Jumlah Obat 4">-->
	            	<!-- data obat 4 -->

	            	<!-- data obat 5 -->
		        <select name="obat5" class="form-control" placeholder="Obat 5" id="obat5" type="select"> 
	             	<?php $sqlobat5 = "SELECT * FROM tb_obat";
					$queryobat5 = mysqli_query($koneksi, $sqlobat5); ?>
	             	<?php while($dataobat5 = mysqli_fetch_assoc($queryobat5)){ ?>
					<option value="<?php echo $dataobat5['id_obat']; ?>">
					<?php echo $dataobat5['nama_obat']; ?>
					</option>
					<?php } ?>
	            	...
	            	<!-- data obat 6 -->
		        <select name="obat6" class="form-control" placeholder="Obat 6" id="obat6" type="select"> 
	             	<?php $sqlobat6 = "SELECT * FROM tb_obat";
					$queryobat6 = mysqli_query($koneksi, $sqlobat6); ?>
	             	<?php while($dataobat6 = mysqli_fetch_assoc($queryobat6)){ ?>
					<option value="<?php echo $dataobat6['id_obat']; ?>">
					<?php echo $dataobat6['nama_obat']; ?>
					</option>
					<?php } ?>
	            ...
	            <div class="control-group">
	              <div class="form-group floating-label-form-group controls mb-0 pb-2">
	                ...
	                <input class="form-control" id="tindakan" type="text" name="tindakan" placeholder="Tindakan Pasien" required="required" data-validation-required-message="Silahkan Masukkan Tindakan Pasien">
	                <p class="help-block text-danger"></p>
	              </div>
	            </div>	
...
function tampil_data($koneksi){
	...
	//$hari_ini = date('Y-m-d');
	//$sql= "SELECT * FROM tb_rekammedis WHERE tgl_periksa = '$hari_ini'";
	
	//QUERY NAMA DAN ID PASIEN
	$sql= "SELECT DISTINCT id_pasien FROM tb_rekammedis";
	//$sql= "SELECT DISTINCT nama FROM tb_rekammedis";
	//DISTINCT
...
<!--				<td><?php echo $data['id_rm']; ?>		</td>-->
				...
				<td>
					...
					<a href="detail.php?&tp= <?php echo $data['id_pasien']; ?>"
...
<!-- //DI GANTI MENYESUAIKAN TABLE/ KALO INI TABLE DOKTER/DIGANTI MENYESUIKAN DATA TABLE       		--> 
            	...
            	<div class="control-group">
	              	<div class="form-group floating-label-form-group controls mb-0 pb-2">
		                ...
		                <input class="form-control" id="id_pasien" name="id_pasien" type="text" placeholder="Nama Pasien" required="required" 
		                value="<?php echo $_GET['id_pasien'] ?>">
		                <p class="help-block text-danger"></p>
              		</div>
            	</div>
